...
from .views import CreateRoomView, GetRoom, JoinRoomView, RoomView,userInRoom, LeaveRoom,UpdateRoomView
...
urlpatterns = [
    ...
    path('update-room/', views.UpdateRoomView.as_view(), name='update-room')
